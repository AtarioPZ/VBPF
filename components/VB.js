                    ...
                    <div className="flex flex-col sm:flex-row mt-10">
                      <div className="sm:w-1/3 text-center sm:pr-8 sm:py-8">
                        ...
                        <div className="flex flex-col items-center text-center justify-center">
                          ...
                          <p className="text-base">Dev based in India</p>
                        </div>
                      </div>
                      ...
                      >
                        <p className="leading-relaxed text-xl mb-4">Hello. I am an Indie Game and Dot Net Software Developer   <br></br>
                        </p>
                      </motion.div>
                    </div>
                  </div>
                          ...
                          <div className="container px-5 py-24 mx-auto">
                            <div className="flex flex-wrap -m-4">
                              <div className="lg:w-1/4 md:w-1/2 p-2 w-full">
                                ...
                                <Image alt="C-sharp" width={100} height={100}  src="/c-s.png" />
                                </a>
                              </div>
                              <div className="lg:w-1/4 md:w-1/2 p-2 w-full">
                                <a className="block relative h-48 rounded overflow-hidden">
                                  <Image alt="DOT NET" width={100} height={100} src="/dotnet.png" />
                                </a>
                              </div>                              
                              <div className="lg:w-1/4 md:w-1/2 p-2 w-full">
                                <a className="block relative h-48 rounded overflow-hidden">
                                  <Image alt="JS" width={100} height={100} src="/js.png" />
                                </a>
                                
                              </div>
                              <div className="lg:w-1/4 md:w-1/2 p-2 w-full">
                                <a className="block relative h-48 rounded overflow-hidden">
                                  <Image alt="MySQL" width={100} height={100} src="/mysql.png" />
                                </a>
                              </div>
                              <div className="lg:w-1/4 md:w-1/2 p-2 w-full">
                                <a className="block relative h-48 rounded overflow-hidden">
                                  <Image alt="Unity" width={100} height={100} src="/unity.png" />
                                </a>
                              </div>                              
                            </div>
                          </div>
